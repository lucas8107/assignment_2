...
// System.out.print("Would you like to use GUI (Status on console) (1 - yes/2 -
// no) ? : ");
// boolean useGUI;
// if (stdin.nextInt() == 1)
// useGUI = true;
...
// if (!player) {
// node = new Node(start.clone(), true, slots.clone(), -1, node.getDepth() + 1,
// ai);
...
// if (useGUI)
// field.drawMove(node.getMove() * 70, (6 - slots[node.getMove()]) * 70,
// colorAI);
...
// if (botXbot) {
// node_2 = new Node(start.clone(), true, slots.clone(), -1, node_2.getDepth() +
// 1, you);
// // Util.draw2Darray(start);
// if (isTerminal(start) && !tie) {
...
// if (useGUI)
// field.drawMove(node_2.getMove() * 70, (6 - slots[node_2.getMove()]) * 70,
// colorHuman);
// Util.draw2Darray(start);
// } else if (!useGUI) {
// if (isTerminal(start) && !tie) {
...
// System.out.print("Choose " + str + " color (BLUE - 1, RED - 2, GREEN - 3,
// YELLOW - 4, MAGENTA - 5): ");
